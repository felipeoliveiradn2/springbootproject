...
import com.projectspringboot.projectspring.repositories.CategoryRepository;
import com.projectspringboot.projectspring.repositories.OrderItemRepository;
import com.projectspringboot.projectspring.repositories.OrderRepository;
import com.projectspringboot.projectspring.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner { // CommandLIneRunner para iniciar o testconfig quando o programa for iniciado
	...
	public void run(String... args) throws Exception { //tudo dentro do run é executado quando a aplicação for iniciada
		...
		//salva todas categorias em um array de lista
		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		
		//usa OO para adicionar as categorias aos produtos
		...
		//chama novamente o productRepository para salvar tudo na lista com as associações
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
